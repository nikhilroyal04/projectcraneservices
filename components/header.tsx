          ...
          {language === "ar" && (
            <div className="hidden md:flex items-center space-x-4">
              <div className="relative">
                ...
                <span className="absolute -top-2 -right-2 bg-yellow-400 text-xs font-medium px-1.5 py-0.5 rounded-sm text-black">
                  {t("nav.byVisanet")}
                </span>
              </div>
              <LanguageSwitcher />
          ...
          >
            <nav className="flex flex-col space-y-4">
              ...
              <motion.div
                ...
                className="relative"
              >
                <Button className="bg-red-800 hover:bg-red-700 text-white w-full justify-center">
